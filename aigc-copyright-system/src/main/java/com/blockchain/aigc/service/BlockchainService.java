...
public class BlockchainService {
    ...
    public void doAction(String contractAddress, CryptoKeyPair userKeyPair) throws Exception {
        AddressAction contract = AddressAction.load(contractAddress, client, userKeyPair);
        contract.doAction("实名认证完成");
    }
