...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<Void> handleGlobalException(HttpServletRequest request, GlobalException ex) {
    ...
    public ApiResponse<Void> handleSystemException(HttpServletRequest request, Exception ex) {
